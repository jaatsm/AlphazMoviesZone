...
PICS = (environ.get('PICS', 'https://graph.org/file/04729c9cc364a7278372b-1d7d9857f26854166c.jpg')).split()
...
QR_CODE = environ.get('QR_CODE', 'https://graph.org/file/8eb1aabee951f9cf7a286-97b55adb6be9810ba6.jpg') # Scanner Code image 
...
premium = environ.get('PREMIUM_LOGS', '-1002465777822')
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002424089899').split()]
# post channel auto post new movie
POST_CHANNELS = list(map(int, (channel.strip() for channel in environ.get('POST_CHANNELS', '-1002442539516').split(','))))
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/M0VIES_REQUEST_Group')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Movies_Kingston')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1002397734236))
